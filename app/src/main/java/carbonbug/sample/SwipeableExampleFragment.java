...
import carbonbug.sample.common.data.AbstractDataProvider;
import carbonbug.sample.common.data.ExampleDataProvider;
...
public class SwipeableExampleFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        final SwipeableExampleAdapter myItemAdapter = new SwipeableExampleAdapter(new ExampleDataProvider());
